...
def train(
        ...
        target_modules: List[str] = ["up_proj","gate_proj"],
    ...
    print(
        ...
        f"lora_r: {lora_r}\n"
        f"embedding_alpha: {embedding_alpha}\n"
        f"att: {att}\n"
        f"ffn: {ffn}\n"
    ...
    our_args = {'att':att, 'ffn':ffn,'embedding_alpha':embedding_alpha,'adapter':adapter_name}
